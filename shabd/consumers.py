...
# stricrredis
r = redis.Redis(host='redis-18556.c14.us-east-1-2.ec2.cloud.redislabs.com',port='18556',password='UOzUP6BRWuRGaMveImPsc9lejeFnNNtL',db='django-chat',decode_responses=True)
